...
<div class="shortcut">
  <div class="page">
    ...
    <div class="shortcut-right">
      <ul id="login_show">
      		              <li><a href="" rel="nofollow" title=""></a></li>
...
<form name="myFrom" id="myFrom" method="post" action="">
    ...
    <div class="dingdan">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1"  class="table1">
            ...
            <c:forEach items="${cartDTOList}" var="cartDTO">
            <tr>
	                <td height="95" align="center">
	                    <div class="contact_way_img"><img src="${static_source}${cartDTO.goodDTO.goodImg}"></div>
	                    <div class="contact_way_txt"><p><span>${cart.goodDTO.goodName}</span></p></div>
	                    <div class="clear"></div>
	                </td>
        ...
        <%--<div class="foot_bor"> <em id="sumCount">1</em>件产品总计回收价格<em id="sumPrice" style="font-size:18px;"></em> <!--<span>赠送环保券 <i>30</i>元--></span></div>--%>
    </div>
    <!--订单-->
    </div>
    <!--提交订单-->
